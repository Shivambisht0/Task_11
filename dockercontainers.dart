...
main() {
  runApp(MaterialApp(
    home: MyDockerContainer(),
    debugShowCheckedModeBanner: false,
  ));
}

class MyDockerContainer extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<MyDockerContainer> {
  var x = "The output will be here ";
  late String cmd;
  late String name;
  web() async {
    var url = Uri.http("192.168.23.7", "/cgi-bin/app3.py");
              ...
              FloatingActionButton(
                ...
                /*onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          MyLogin(cmd: "$x", name: "$y", surname: "$z"),
                    ),
                  );
                },
                */
